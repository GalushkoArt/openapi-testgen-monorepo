---
description: Learn how OpenAPI Test Generator creates negative tests for query parameters, including missing required parameters and invalid values. Covers complex object parameters, filtering options, and output inspection.
---
